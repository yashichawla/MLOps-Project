#!/bin/bash
# Deployment script for Metrics Dashboard to Google Cloud Run

set -e

echo "=========================================="
echo "Deploying Metrics Dashboard to Google Cloud Run"
echo "=========================================="
echo ""
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo "Open the URL in your browser to access the dashboard"
    exit 0
fi
